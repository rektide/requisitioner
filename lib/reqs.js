var astify= require("./util/astify.js"),
  mainGather= require("./util/mainGather.js"),  
  fs= require("fs"),
...
*/
module.exports= exports= function(opts,files___){
...
function runMain(argv,stdin,stdout,stderr,run){
	...
	var gather= mainGather(argv,stdin)
	// pump all files into our reqs run
	gather.on("data",function(files){
		// we have files, reqs them
		run.reqsMore.apply(run,files)
	})
